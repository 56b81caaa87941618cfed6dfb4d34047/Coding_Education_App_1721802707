...
*/
Vue.component("simple_footer_component_1721802708", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            CodeSpark - Learn to Code with Fun
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        CodeSpark makes learning to code an engaging adventure for kids. Our interactive coding games and lessons nurture problem-solving skills while sparking creativity.
                    </div>
                </div>
            </div>
        </footer> 
